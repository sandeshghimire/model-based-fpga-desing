###########################################################################
## Makefile generated for Simulink model 'hdlcodercpu_eml'. 
## 
## Makefile     : hdlcodercpu_eml.mk
## Generated on : Sun Aug 24 14:18:05 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\hdlcodercpu_eml.exe
...
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = hdlcodercpu_eml_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hdlcodercpu_eml.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\hdlcodercpu_eml_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=hdlcodercpu_eml -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\hdlcodercpu_eml_grt_rtw\hdlcodercpu_eml.c $(START_DIR)\hdlcodercpu_eml_grt_rtw\hdlcodercpu_eml_data.c $(START_DIR)\hdlcodercpu_eml_grt_rtw\rtGetInf.c $(START_DIR)\hdlcodercpu_eml_grt_rtw\rtGetNaN.c $(START_DIR)\hdlcodercpu_eml_grt_rtw\rt_nonfinite.c rt_logging.c rt_sim.c $(MATLAB_ROOT)\rtw\c\grt\classic_main.c
...
OBJS = hdlcodercpu_eml.obj hdlcodercpu_eml_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj rt_sim.obj classic_main.obj
...
{$(START_DIR)\hdlcodercpu_eml_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\hdlcodercpu_eml_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
