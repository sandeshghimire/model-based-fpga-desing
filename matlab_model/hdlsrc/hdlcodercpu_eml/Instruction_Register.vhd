-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\hdlcodercpu_eml\Instruction_Register.vhd
...
BEGIN
  ...
  Instruction_Register_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        IR_value <= to_unsigned(2#000000000000#, 12);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    ...
    -- HDL specific fimath
    --'<S8>:1:22'
    IR_out_tmp <= to_unsigned(2#000000000000#, 12);

    CASE func_unsigned IS
      WHEN "00" =>
        -- reset
        --'<S8>:1:27'
        IR_value_next <= to_unsigned(2#000000000000#, 12);
      WHEN "01" =>
        -- store into IR
        --'<S8>:1:30'
