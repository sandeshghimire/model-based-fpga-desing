...
static void initialize_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initialize_params_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void enable_c4_gm_hdlcodercpu_eml(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void disable_c4_gm_hdlcodercpu_eml(SFc4_gm_hdlcodercpu_emlInstanceStruct *
  chartInstance);
static void c4_update_debugger_state_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void set_sim_state_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_gm_hdlcodercpu_eml(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void c4_chartstep_c4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initSimStructsc4_gm_hdlcodercpu_eml
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static uint8_T c4_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int8_T c4_b_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_alu_out, const char_T *c4_identifier);
static int8_T c4_c_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_d_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_f_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_is_zero, const char_T *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_h_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_i_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int8_T c4_i_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_j_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int16_T c4_j_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void c4_eml_fi_checkforconst(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static uint8_T c4_uint8(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint8_T c4_A);
static void c4_b_eml_fi_checkforconst(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static uint8_T c4_bitcmp(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint8_T c4_a);
static int8_T c4_b_bitcmp(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int8_T c4_a);
static void c4_sub_w_borrow(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int8_T c4_u1, int8_T c4_u2, uint8_T c4_b_in, int8_T *c4_diff, uint8_T
  *c4_carry, uint8_T *c4_overflow);
static void c4_sum_w_carry(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int8_T c4_u1, int8_T c4_u2, uint8_T c4_c_in, int8_T *c4_sum, uint8_T *c4_carry,
  uint8_T *c4_overflow);
static uint16_T c4_bitconcat(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, uint8_T c4_varargin_1, int8_T c4_varargin_2);
static void c4_c_eml_fi_checkforconst(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static int16_T c4_plus(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int16_T c4_a0, int16_T c4_b0);
static int16_T c4_b_plus(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int16_T c4_a0, uint8_T c4_b0);
static int8_T c4_bitand(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int8_T c4_a, int8_T c4_b);
static boolean_T c4_all(SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  int8_T c4_x);
static const mxArray *c4_k_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_k_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_m_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_l_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_out_flags, const char_T *c4_identifier);
static uint8_T c4_m_emlrt_marshallIn(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_j_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void init_dsm_address_info(SFc4_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
  ...
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_gm_hdlcodercpu_eml = 0U;
  ...
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = chartInstance->c4_is_active_c4_gm_hdlcodercpu_eml;
  ...
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_out_flags = c4_l_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "out_flags");
  chartInstance->c4_is_active_c4_gm_hdlcodercpu_eml = c4_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_gm_hdlcodercpu_eml");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_gm_hdlcodercpu_eml(chartInstance);
  ...
  (SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_gm_hdlcodercpu_eml(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_b_y = NULL;
  SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  chartInstance = (SFc4_gm_hdlcodercpu_emlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_gm_hdlcodercpu_eml_get_eml_resolved_functions_info(void)
{
...
void sf_c4_gm_hdlcodercpu_eml_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_gm_hdlcodercpu_eml_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_gm_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_gm_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_gm_hdlcodercpu_eml(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"alu_out\",},{M[1],M[9],T\"out_flags\",},{M[8],M[0],T\"is_active_c4_gm_hdlcodercpu_eml\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_gm_hdlcodercpu_eml_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_gm_hdlcodercpu_emlInstanceStruct *)
...
static void sf_opaque_initialize_c4_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
  initialize_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  enable_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  disable_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  sf_gateway_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_gm_hdlcodercpu_eml(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_gm_hdlcodercpu_eml
    ((SFc4_gm_hdlcodercpu_emlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_gm_hdlcodercpu_eml();/* state var info */
...
extern void sf_internal_set_sim_state_c4_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_gm_hdlcodercpu_eml();/* state var info */
  ...
  set_sim_state_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_gm_hdlcodercpu_eml(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_gm_hdlcodercpu_eml(S);
}

static void sf_opaque_set_sim_state_c4_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_gm_hdlcodercpu_eml(S, st);
}

static void sf_opaque_terminate_c4_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_gm_hdlcodercpu_emlInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_gm_hdlcodercpu_eml((SFc4_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_gm_hdlcodercpu_eml(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_gm_hdlcodercpu_eml
      ((SFc4_gm_hdlcodercpu_emlInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_gm_hdlcodercpu_eml(SimStruct *S)
{
  SFc4_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_gm_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
    (SFc4_gm_hdlcodercpu_emlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_gm_hdlcodercpu_emlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_gm_hdlcodercpu_eml;
...
void c4_gm_hdlcodercpu_eml_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_gm_hdlcodercpu_eml(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_gm_hdlcodercpu_eml_method_dispatcher.\n"
