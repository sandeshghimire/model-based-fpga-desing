...
static void initialize_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initialize_params_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void enable_c7_gm_hdlcodercpu_eml(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void disable_c7_gm_hdlcodercpu_eml(SFc7_gm_hdlcodercpu_emlInstanceStruct *
  chartInstance);
static void c7_update_debugger_state_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void set_sim_state_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_gm_hdlcodercpu_eml(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void c7_chartstep_c7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initSimStructsc7_gm_hdlcodercpu_eml
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static uint8_T c7_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_b_PC_value, const char_T *c7_identifier);
static uint8_T c7_b_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static uint8_T c7_c_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_addr_out, const char_T *c7_identifier);
static uint8_T c7_d_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_e_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
static void c7_eml_fi_checkforconst(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static uint8_T c7_uint8(SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint8_T c7_A);
static void c7_eml_scalar_eg(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static const mxArray *c7_g_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
static const mxArray *c7_h_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_gm_hdlcodercpu_eml, const
  char_T *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
  ...
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_gm_hdlcodercpu_eml = 0U;
  ...
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  c7_c_hoistedGlobal = chartInstance->c7_is_active_c7_gm_hdlcodercpu_eml;
  ...
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *c7_addr_out = c7_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c7_is_active_c7_gm_hdlcodercpu_eml = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 2)),
     "is_active_c7_gm_hdlcodercpu_eml");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_gm_hdlcodercpu_eml(chartInstance);
  ...
  (SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_gm_hdlcodercpu_eml(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_b_y = NULL;
  SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  chartInstance = (SFc7_gm_hdlcodercpu_emlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_gm_hdlcodercpu_eml_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_gm_hdlcodercpu_eml), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_gm_hdlcodercpu_eml);
  return c7_y;
}
...
void sf_c7_gm_hdlcodercpu_eml_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_gm_hdlcodercpu_eml_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_gm_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_gm_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_gm_hdlcodercpu_eml(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"addr_out\",},{M[4],M[0],T\"PC_value\",S'l','i','p'{{M1x2[371 379],M[0],}}},{M[8],M[0],T\"is_active_c7_gm_hdlcodercpu_eml\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_gm_hdlcodercpu_eml_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_gm_hdlcodercpu_emlInstanceStruct *)
...
static void sf_opaque_initialize_c7_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
  initialize_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  enable_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  disable_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  sf_gateway_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_gm_hdlcodercpu_eml(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_gm_hdlcodercpu_eml
    ((SFc7_gm_hdlcodercpu_emlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_gm_hdlcodercpu_eml();/* state var info */
...
extern void sf_internal_set_sim_state_c7_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_gm_hdlcodercpu_eml();/* state var info */
  ...
  set_sim_state_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_gm_hdlcodercpu_eml(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_gm_hdlcodercpu_eml(S);
}

static void sf_opaque_set_sim_state_c7_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_gm_hdlcodercpu_eml(S, st);
}

static void sf_opaque_terminate_c7_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_gm_hdlcodercpu_emlInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_gm_hdlcodercpu_eml((SFc7_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_gm_hdlcodercpu_eml(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_gm_hdlcodercpu_eml
      ((SFc7_gm_hdlcodercpu_emlInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_gm_hdlcodercpu_eml(SimStruct *S)
{
  SFc7_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_gm_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
    (SFc7_gm_hdlcodercpu_emlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_gm_hdlcodercpu_emlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_gm_hdlcodercpu_eml;
...
void c7_gm_hdlcodercpu_eml_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_gm_hdlcodercpu_eml(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_gm_hdlcodercpu_eml_method_dispatcher.\n"
