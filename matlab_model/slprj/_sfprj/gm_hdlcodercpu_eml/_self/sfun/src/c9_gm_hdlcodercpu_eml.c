...
static void initialize_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initialize_params_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void enable_c9_gm_hdlcodercpu_eml(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void disable_c9_gm_hdlcodercpu_eml(SFc9_gm_hdlcodercpu_emlInstanceStruct *
  chartInstance);
static void c9_update_debugger_state_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void set_sim_state_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c9_st);
static void finalize_c9_gm_hdlcodercpu_eml(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void c9_chartstep_c9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void initSimStructsc9_gm_hdlcodercpu_eml
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static uint8_T c9_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c9_PC_next, const char_T *c9_identifier);
static uint8_T c9_b_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
...
static const mxArray *c9_d_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_c_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_f_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_d_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_g_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint8_T c9_e_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_gm_hdlcodercpu_eml, const
  char_T *c9_identifier);
static uint8_T c9_f_emlrt_marshallIn(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_gm_hdlcodercpu_emlInstanceStruct
  *chartInstance);
  ...
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_gm_hdlcodercpu_eml = 0U;
  ...
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  c9_b_hoistedGlobal = chartInstance->c9_is_active_c9_gm_hdlcodercpu_eml;
  ...
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_PC_next = c9_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c9_u, 0)), "PC_next");
  chartInstance->c9_is_active_c9_gm_hdlcodercpu_eml = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 1)),
     "is_active_c9_gm_hdlcodercpu_eml");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_gm_hdlcodercpu_eml(chartInstance);
  ...
  (SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_sfEvent = CALL_EVENT;
  c9_chartstep_c9_gm_hdlcodercpu_eml(chartInstance);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_b_y = NULL;
  SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  chartInstance = (SFc9_gm_hdlcodercpu_emlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_gm_hdlcodercpu_eml_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c9_identifier)
{
  ...
  c9_y = c9_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_gm_hdlcodercpu_eml), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_gm_hdlcodercpu_eml);
  return c9_y;
}
...
void sf_c9_gm_hdlcodercpu_eml_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_gm_hdlcodercpu_eml_get_autoinheritance_info(void)
{
...
mxArray *sf_c9_gm_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_gm_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c9_gm_hdlcodercpu_eml(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"PC_next\",},{M[8],M[0],T\"is_active_c9_gm_hdlcodercpu_eml\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_gm_hdlcodercpu_eml_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_gm_hdlcodercpu_emlInstanceStruct *)
...
static void sf_opaque_initialize_c9_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
  initialize_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  enable_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  disable_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  sf_gateway_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_gm_hdlcodercpu_eml(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_gm_hdlcodercpu_eml
    ((SFc9_gm_hdlcodercpu_emlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_gm_hdlcodercpu_eml();/* state var info */
...
extern void sf_internal_set_sim_state_c9_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c9_gm_hdlcodercpu_eml();/* state var info */
  ...
  set_sim_state_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_gm_hdlcodercpu_eml(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_gm_hdlcodercpu_eml(S);
}

static void sf_opaque_set_sim_state_c9_gm_hdlcodercpu_eml(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_gm_hdlcodercpu_eml(S, st);
}

static void sf_opaque_terminate_c9_gm_hdlcodercpu_eml(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_gm_hdlcodercpu_emlInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_gm_hdlcodercpu_eml((SFc9_gm_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_gm_hdlcodercpu_eml(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c9_gm_hdlcodercpu_eml
      ((SFc9_gm_hdlcodercpu_emlInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c9_gm_hdlcodercpu_eml(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_gm_hdlcodercpu_eml(SimStruct *S)
{
  SFc9_gm_hdlcodercpu_emlInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_gm_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
    (SFc9_gm_hdlcodercpu_emlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_gm_hdlcodercpu_emlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_gm_hdlcodercpu_eml;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_gm_hdlcodercpu_eml;
...
void c9_gm_hdlcodercpu_eml_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_gm_hdlcodercpu_eml(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_gm_hdlcodercpu_eml(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_gm_hdlcodercpu_eml_method_dispatcher.\n"
