...
static void finalize_c8_hdlcodercpu_eml(SFc8_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c8_hdlcodercpu_eml(SFc8_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
mxArray *sf_c8_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_hdlcodercpu_emlInstanceStruct *)
...
{
  sf_gateway_c8_hdlcodercpu_eml((SFc8_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}
  ...
  mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_hdlcodercpu_eml();/* state var info */
...
static void mdlStart_c8_hdlcodercpu_eml(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
