...
static void finalize_c1_hdlcodercpu_eml(SFc1_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c1_hdlcodercpu_eml(SFc1_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
static void c1_eml_fi_checkforconst(SFc1_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
static uint8_T c1_f_emlrt_marshallIn(SFc1_hdlcodercpu_emlInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_hdlcodercpu_eml, const char_T
  *c1_identifier);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_hdlcodercpu_eml = 0U;
  ...
  (SFc1_hdlcodercpu_emlInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_hdlcodercpu_eml;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  *c1_y = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "y");
  chartInstance->c1_is_active_c1_hdlcodercpu_eml = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_hdlcodercpu_eml");
  sf_mex_destroy(&c1_u);
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_hdlcodercpu_eml), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_hdlcodercpu_eml);
  return c1_y;
}
...
mxArray *sf_c1_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_hdlcodercpu_emlInstanceStruct *)
...
{
  sf_gateway_c1_hdlcodercpu_eml((SFc1_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}
  ...
  mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_hdlcodercpu_eml();/* state var info */
...
static void mdlStart_c1_hdlcodercpu_eml(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
