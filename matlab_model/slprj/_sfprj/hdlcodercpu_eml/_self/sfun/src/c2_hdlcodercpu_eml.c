...
static void finalize_c2_hdlcodercpu_eml(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void sf_gateway_c2_hdlcodercpu_eml(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
static void c2_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void c2_b_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void c2_c_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void c2_d_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static void c2_e_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
static boolean_T c2_b_logical(SFc2_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint8_T c2_a);
static void c2_eml_scalar_eg(SFc2_hdlcodercpu_emlInstanceStruct *chartInstance);
static int8_T c2_minus(SFc2_hdlcodercpu_emlInstanceStruct *chartInstance, int8_T
  c2_a0);
static uint16_T c2_bitsrl(SFc2_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint16_T c2_ain);
static void c2_eml_switch_helper(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
static uint16_T c2_eml_feval(SFc2_hdlcodercpu_emlInstanceStruct *chartInstance,
  uint16_T c2_varargin_1, int32_T c2_varargin_2);
static void c2_f_eml_fi_checkforconst(SFc2_hdlcodercpu_emlInstanceStruct
  *chartInstance);
...
mxArray *sf_c2_hdlcodercpu_eml_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_hdlcodercpu_eml_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_hdlcodercpu_emlInstanceStruct *)
...
{
  sf_gateway_c2_hdlcodercpu_eml((SFc2_hdlcodercpu_emlInstanceStruct*)
    chartInstanceVar);
}
  ...
  mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_hdlcodercpu_eml();/* state var info */
...
static void mdlStart_c2_hdlcodercpu_eml(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_hdlcodercpu_emlInstanceStruct *)utMalloc(sizeof
