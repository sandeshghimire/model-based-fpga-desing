...
MODEL              = gm_hdlcodercpu_eml
MODULES            = gm_hdlcodercpu_eml_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = gm_hdlcodercpu_eml.mk
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f "C:\Users\sandesh\AppData\Roaming\MathWorks\MATLAB\R2014a\mex_C_win64.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MODELLIB                  = gm_hdlcodercpu_emllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\gm_hdlcodercpu_eml
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\hdlsrc\hdlcodercpu_eml
